  ...
  },
{
  ...
  },
  {
    ...
    answer: '문제에 용어 미제공/ 예시: 멀웨어/ 랜섬웨어/ 피싱 등, 멀웨어: • 의도적으로 컴퓨터 네트워크 중단/ 개인 정보 유출/ 정보/시스템에 대한 무단 액세스 권한 획득을 위해 설계된 모든 소프트웨어 / • 바이러스/ 웜/ 트로이목마/ 스파이웨어/ 피싱(phishing) 소프트웨어, 랜섬웨어: • ‘암호화 기법’을 사용하는 멀웨어/ • 몸값을 지불하지 않으면 피해자의 개인 데이터를 게시하거나 해당 데이터에 대한 액세스를 영구적으로 차단하겠다고 위협/ • 해커에게 몸값을 지불하면 키를 제공하거나 무시함',
  },
]
